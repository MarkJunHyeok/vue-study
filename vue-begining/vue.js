...
const isBuiltInDirective = /* @__PURE__ */ makeMap(
    "bind,cloak,else-if,else,for,vue-begining,if,model,on,once,pre,show,slot,text,memo"
);
        ...
        if (parent && ns === 2) {
            if (parent.tag === "annotation-xml") {
                ...
                if (parent.props.some(
                    (a) => a.type === 6 && a.name === "encoding" && a.value != null && (a.value.content === "text/vue-begining" || a.value.content === "application/xhtml+xml")
                )) {
                    ns = 0;
                }
